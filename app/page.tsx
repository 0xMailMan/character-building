...
export default function CharacterForge() {
  ...
  return (
    <>
      ...
      {isMobile ? (
        /* Mobile: single column — header (hamburger), preview, actions, then category buttons + TraitPanel below */
        <main className="flex min-h-screen flex-col">
          ...
          <div className="flex w-full items-center justify-between gap-2 p-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-xl font-bold text-foreground tracking-tight">Character Forge</h1>
                <p className="text-xs text-muted-foreground">Customize. Create. Mint.</p>
              </div>
            </div>
            <Badge variant="outline" className="border-primary/40 text-primary gap-1.5 shrink-0">
          ...
          {/* Trait section: category buttons above, TraitPanel below */}
          <div className="flex w-full flex-col border-t border-border bg-card min-w-0">
            <div className="overflow-x-auto overflow-y-hidden min-w-0">
              <nav
                className="flex gap-1 p-3 w-max min-w-full"
                ...
                {TRAIT_CATEGORIES.map((cat) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        "flex items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium transition-all whitespace-nowrap shrink-0",
